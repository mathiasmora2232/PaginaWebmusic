(function(){
  ...
  fetch('data/events.json')
        ...
        <div class=\"seat-map\">
          <div class=\"seat-map-content\"> 
            <div>
              ...
              ${ev.seatMapImage ? `<img src=\"${ev.seatMapImage}\" alt=\"Mapa de localidades ${ev.title}\"/>` : `<p class=\"muted\">Mapa referencial</p>`}
              <p class=\"muted\">La selección de zona y cantidad se realiza en el checkout.</p>
            </div>
        ...
        <div class=\"event-head\">
          ...
          <div class=\"event-info\">
            ...
            <div class=\"event-actions\"> 
              ...
              <a href=\"checkout.html?id=${ev.id}\" class=\"btn\">Comprar</a>
            </div>
    ...
    .finally(()=> {
      ...
      // Inicializa mapa embebido si existe
